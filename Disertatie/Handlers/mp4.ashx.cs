...
namespace Disertatie.Handlers
{
    ...
    public class mp4 : IHttpHandler, IRequiresSessionState
    {
        ...
        {
            CloudStorageConsumer cloudConsumer = HttpContext.Current.Session["boxConsumer"] as CloudStorageConsumer;
            Stream videoStream = cloudConsumer.GetDocument("28081161782");
            byte[] videoArray;
